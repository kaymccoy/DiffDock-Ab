...
from utils import compute_rmsd, printt #***** added printt
...
def load_data(args, split=None, batch=None, verbose=True):
    ...
    if args.dataset == "dips":
        ...
        printt("testing DB5 loader")
    elif args.dataset == "toy":
        data = data_utils.ToyLoader(args, 
        split=split, batch=batch, verbose=verbose)
        printt("testing ToyLoader loader")
    else:
