...
def sample(data_list, model, args, epoch=0, visualize_first_n_samples=0,
    ...
    #*****
    printt("testing in_batch_size: ", in_batch_size)
    ...
    #*****
    printt("testing timesteps: ", timesteps)

    # Prepare for visualizations
    visualize_first_n_samples = min(visualize_first_n_samples, len(data_list))

    #*****
    printt("testing visualize_first_n_samples: ", visualize_first_n_samples)
    ...
    for t_idx in range(args.num_steps):
        ...
        #*****
        print("testing args.batch_size: ", args.batch_size)
        ...
        printt("testing 6...")
        printt("testing enumerating test_loader:")
